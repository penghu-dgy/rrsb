$(function () {
    $("#jqGrid").jqGrid({
        ...
        datatype: "json",
        colModel: [			
			{ label: '编号', name: 'payid', index: 'payId', width: 50, key: true },
			{ label: '金额', name: 'paymoney', index: 'payMoney', width: 80 }, 			
			{ label: '用户截止时间', name: 'payexpiretime', index: 'payExpireTime', width: 80 }, 			
			{ label: '支付时间', name: 'paytime', index: 'payTime', width: 80 }, 			
			{ label: '员工编号', name: 'payemp', index: 'payEmp', width: 80 }, 			
			{ label: '企业编号', name: 'entid', index: 'entId', width: 80 }, 			
			{ label: '支付类型', name: 'zflx', index: 'zflx', width: 80 }, 			
			{ label: '支付账号', name: 'zfzh', index: 'zfzh', width: 80 }, 			
			{ label: '支付编号', name: 'zfbh', index: 'zfbh', width: 80 }, 			
