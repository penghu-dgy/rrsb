$(function () {
    $("#jqGrid").jqGrid({
        ...
        datatype: "json",
        colModel: [			
			{ label: '编号', name: 'empid', index: 'empId', width: 50, key: true },
			{ label: '姓名', name: 'empname', index: 'empName', width: 80 }, 			
			{ label: '类型', name: 'emptype', index: 'empType', width: 80 }, 			/*
			{ label: '', name: 'enpbirthday', index: 'enpBirthday', width: 80 }, 	*/		
			{ label: '入职时间', name: 'emphiretime', index: 'empHireTime', width: 80 }, 			
		/*	{ label: '', name: 'emptime', index: 'empTime', width: 80 }, 		*/	
			{ label: '截止时间', name: 'empexpiretime', index: 'empExpireTime', width: 80 }, 			
			/*{ label: '', name: 'empperformance', index: 'empPerformance', width: 80 }, 		*/	
			/*{ label: '', name: 'empsex', index: 'empSex', width: 80 }, 		*/	
			{ label: '手机号码', name: 'empphone', index: 'empPhone', width: 80 }, 			
			...
			{ label: '企业ID', name: 'empent', index: 'empEnt', width: 80 }, 			
